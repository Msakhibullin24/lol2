<section>
        <h2 class="text-lg font-medium  ">
            <img src="/img/4.png" style="float: inline-start; margin-right: 10px;">{{ __('Регистрация полезной модели') }}<div class="" style="    display: block;    position: relative;    float: inline-end;">
    ...
    <form method="post" action="{{ route('orders.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
		...
		<div class="form-container">
			<div class="form-field">
				<div>
					<x-input-label for="name_izopm" :value="__('Название изобретения/полезной модели.')"   class="required-field" />
