			...
			<div class="row">
				<div class="col-md-9 col-sm-12">
					<div class="card card-primary">
						<div class="card-body">
							<div class="row">
								<form method="post" action="{{ route('administrator.blog_save') }}" style="display: contents;">
									...
									<div class="col-md-3 col-sm-12">
										<div class="form-group">
											...
											<div class="custom-control custom-radio">
												<input class="custom-control-input" type="radio" id="customRadio2" name="status" @if($blog->status=='0') checked @endif value="0" >
												<label for="customRadio2" class="custom-control-label form-check-label">Неактивна</label>
											</div>
											<div class="custom-control custom-radio">
												<input class="custom-control-input" type="radio" id="customRadio1" name="status" value="1" @if($blog->status=='1') checked @endif>
