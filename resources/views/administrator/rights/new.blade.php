...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Добавить право</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/administrator/dashboard">Главная</a></li>
            <li class="breadcrumb-item"><a href="/administrator/rights">Реестр прав</a></li>
            <li class="breadcrumb-item active">Добавить право</li>
          </ol>
        </div>
      </div>
    </div>
			...
			<div class="row">
				<div class="col-md-9 col-sm-12">
					<div class="card card-primary">
						<div class="card-body">
							<div class="row">
								<form method="post" action="{{ route('administrator.right_store') }}" style="display: contents;">
									@csrf
									...
									<div class="col-md-1 col-sm-12">
										...
										<input type="number" class="form-control" id="term" name="term" value="0">
									</div>
