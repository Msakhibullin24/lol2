				...
				<div class="col-md-9 col-sm-12">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Авторское право на товарный знак</h3>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-6 col-sm-12">
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<label class="col-form-label" for="per_tov">Перечень товаров и/или услуг</label>
											<textarea class="form-control" rows="3" id="per_tov" name="per_tov">{{$orders->per_tov}}</textarea>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12">
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<label class="col-form-label" for="slov_oboz">Словесное обозначение</label>
											<textarea class="form-control" rows="3" id="slov_oboz" name="slov_oboz">{{$orders->slov_oboz}}</textarea>
										</div>
									</div>
									<div class="row">
				...
				<div class="col-md-3 col-sm-12">
					...
					<div class="card card-success">
						...
						<div class="card-body">
							...
							@if($orders->izo_oboz!='')
							<a href="/storage/{{$orders->izo_oboz}}" target="_blank">{{$orders->izo_oboz}}</a>
							@else
							не загружено
							@endif
							<br>
